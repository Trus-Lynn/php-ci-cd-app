                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5">
                            <div class="single-footer footer-about">
                                ...
                                <div class="footer-brief">
                                    <p>Thephonerstore(PKTL Store) cửa hàng chuyên cung cấp điện thoại chính hãng, giá tốt. Hãy đặt
                                        hàng tại store của chúng tôi để nhận ưu đãi hấp dẫn nhé</p>
                                    <p>Địa chỉ: 835 Trần Hưng Đạo, phường 1, quận 5, TPHCM</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copyright-text">
                                <p class="copy-text"> © 2024 <strong>ThePhoner Store</strong> Tạo bởi <i
                                        class="zmdi zmdi-favorite" style="color: red;" aria-hidden="true"></i>
                                    By <a class="company-name" href="#">
                                        <strong> PKTL Group</strong></a>.</p>
