...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/icon/fox.png">
    <!-- font Roboto -->
    ...
    <!-- Nivo-slider css plugin of jQuery -->
    <link rel="stylesheet" href="assets/lib/css/nivo-slider.css">
    <!-- This core.css file contents all plugings css file. -->
    <link rel="stylesheet" href="assets/css/core.css">
    <!-- Theme shortcodes/elements style by importing header.css to shortcodes.css -->
                                        ...
                                        <li class="mega-parent"><a href="index.php?act=shop">Cửa hàng</a>
                                            <div class="mega-menu-area clearfix">
                                                <div class="mega-menu-link f-left">
                                                    <?php
$cate_list = cate_select_all();// danh mục cha thuộc cate-form.php
// var_dump($cate_list);
...
//các danh mục phụ trong oppo và iphone (all phone, iphone 14) thuộc subcate-list.php
//khi click vào các danh mục phụ thì sẽ được chuyển đến index.php với tham số act=shop và subcateid được gán giá trị là id của danh mục phụ hiện tại
...
$amount_carts = array_reduce($_SESSION['giohang'], function ($prev_value, $curr_val) { //mảng giảm thành một giá trị duy nhất
    // var_dump($prev_value);
    // var_dump($curr_val['sl']);

    return $curr_val['sl'] + $prev_value; //tổng số lượng (sl) của sản phẩm hiện tại ($curr_val['sl']) được cộng với giá trị tích lũy hiện tại ($prev_value)
}, 0);
// echo $amount_carts;
// ở đoạn code tiếp theo khi để chuột vào icon giỏ hàng sẽ hiện ra giỏ hàng của bạn + tổng tiền + xem giỏ hàng + thanh toán
?>
