            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="mt-20 change">
                        <p class="change-p">Hệ thống bán lẻ The Phoner Store(PKTL Store) là một trong những điểm đến tin cậy của người tiêu 
                    ...
                    <div class="active-team-member section">
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Minh Khoa</a></h5>
                                    
                                    <p class="mb-20">Là người phụ trách quản lý công việc và backend</p>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Khánh Tuấn</a></h5>
                                    
                                    <p class="mb-20">Phụ trách công việc thiết kế trang giao diện front end của PKTL Store</p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="#!" title="Facebook"><i
                                                    class="zmdi zmdi-facebook"></i></a>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Lý</a></h5>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#">Thành Phát</a></h5>
                                    
                                    <p class="mb-20">Là người chịu trách nhiệm về Báo cáo, thiết kế database</p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="#!" title="Facebook"><i
                                                    class="zmdi zmdi-facebook"></i></a>
